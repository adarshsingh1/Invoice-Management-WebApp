...
const columns = [
  { field: "sl_no", headerName: "Sl No", width: 85 },
  ...
  { field: "posting_id", headerName: "Posting ID", width: 75 },
...
export const Body = (props) => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8081/HRC60327WK-back_end/Fetch")
      .then((res) => {
  ...
  return (
    <div style={{ backgroundColor: "#283a46" }}>
      <BodyHeader
